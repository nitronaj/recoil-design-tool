...
export const Handle = forwardRef<HTMLDivElement, Props>((props, ref) => {
    const {handleAxis: placement = '', visible = true, ...restProps} = props;
    const size = 10;
    ...
    return (
        <Box
            className={`custom-handle custom-handle-${placement}`}
            position="absolute"
            style={{
                ...position,
                width: size - 2,
